"""
Django settings for HiddenKitchen project.
...
SECRET_KEY = 'django-insecure-lf(b@age2+#j2_17y69i+z+drn2*g74i+l47i1cn45h2pa6ppv'
...
ROOT_URLCONF = 'HiddenKitchen.urls'
...
WSGI_APPLICATION = 'HiddenKitchen.wsgi.application'
...
APP_SERVER = 'https://hidden-kitchen.store/'
